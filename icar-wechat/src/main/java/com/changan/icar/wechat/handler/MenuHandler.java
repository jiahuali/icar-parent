...
import com.changan.icar.wechat.builder.AbstractBuilder;
import com.changan.icar.wechat.builder.ImageBuilder;
import com.changan.icar.wechat.builder.TextBuilder;
import com.changan.icar.wechat.dto.WxMenuKey;
...
public class MenuHandler extends AbstractHandler {
	...
	public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context, WxMpService wxMpService,
		...
		try {
			...
			menuKey = JSON.parse(key, WxMenuKey.class);
		} catch (Exception e) {
